        ...
        <div className="col-12 col-lg-5">
          ...
          <div className="mcpr-card">
            ...
            <p className="text-muted mb-0">
              ...
              We repair with <strong>care, honesty, accountability, attention to detail, and the goal of a satisfied client</strong> who will return and refer others in the future.
            </p>
          </div>
        </div>
      </div>
